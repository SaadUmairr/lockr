...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      className={`${isDark ? 'border-slate-800 bg-slate-900 text-slate-300' : 'border-slate-200 bg-slate-100 text-slate-700'} border-t py-8`}
    >
      <div className="container mx-auto px-4">
        ...
        <hr
          className={`${isDark ? 'border-slate-800' : 'border-slate-200'} my-6`}
        />
